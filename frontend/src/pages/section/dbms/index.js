    ...
    const [playlist, setPlaylist] = useState([
        {
            ...
            thumbnail: "/thumbnails/dbms2.jpg",
            playlistId: 'PLmXKhU9FNesR1rSES7oLdJaNFgmuj0SYV',
        },
        {
            channelName: "Jenny's Lectures CS IT",
            thumbnail: "/thumbnails/dbms.jpg",
            playlistId: 'PLdo5W4Nhv31b33kF46f9aFjoJPOkdlsRc', // Replace with the actual playlist ID
        },
        {
            channelName: "Gate Smashers",
            thumbnail: "/thumbnails/gatesmashersdbms.jpg",
            playlistId: 'PLxCzCOWd7aiFAN6I8CuViBuCdJgiOkT2Y', // Replace with the actual playlist ID
        },
        // {
