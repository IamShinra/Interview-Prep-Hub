...
const WebDevLearning = () => {
    const [playlist, setPlaylist] = useState([
        ...
        },
        {
            ...
            thumbnail: "/thumbnails/anujbhaiya.jpg",
            playlistId: 'PLhzIaPMgkbxDxVcH-M-JFM73PY1R_i2mK', // Replace with the actual playlist ID
        },
        {
            channelName: "Code With Harry",
            thumbnail: "/thumbnails/codewithharry.jpg",
            playlistId: 'PLu0W_9lII9agiCUZYRsvtGTXdxkzPyItg', // Replace with the actual playlist ID
        },
        // {
        //     channelName: "Apna College",
        //     thumbnail: "/thumbnails/apnacollege.jpg",
